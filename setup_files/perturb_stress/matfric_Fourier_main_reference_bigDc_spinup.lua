...
y_extract,extract_tau = read_fractal('/export/dump/jyun/perturb_stress/hf10_reference_2/extract_shearT_first.dat')
y_extract,extract_V = read_fractal('/export/dump/jyun/perturb_stress/hf10_reference_2/extract_sliprate_first.dat')
y_extract,extract_sn = read_fractal('/export/dump/jyun/perturb_stress/hf10_reference_2/extract_normalT_first.dat')
...
function BP1:sn_pre(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/perturb_stress/BigDc_sn_pre_profile','a')
    io.output(file)
...
function BP1:Vinit(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/perturb_stress/BigDc_Vinit_profile','a')
    io.output(file)
...
function BP1:tau_pre(x, y)
    ...
    file = io.open ('/home/jyun/Tandem/perturb_stress/BigDc_tau_pre_profile','a')
    io.output(file)
