...
adj_vs340_1515453 = ridgecrest54.new{model_n='vert_slow',strike=340,fcoeff=0.4,dt=0.01,init_time=2.712094562139096069e+10}
adj3_vs340_1515451 = ridgecrest54.new{model_n='vert_slow',strike=340,fcoeff=0.4,dt=0.01,init_time=2.712094556622940445e+10}
after_vs340_1515453 = ridgecrest54.new{model_n='vert_slow',strike=340,fcoeff=0.4,dt=0.01,init_time=2.712094562139096069e+10}
vs340_1515454 = ridgecrest54.new{model_n='vert_slow',strike=340,fcoeff=0.4,dt=0.01,init_time=2.712094562140095901e+10}
vs340_3092410 = ridgecrest54.new{model_n='vert_slow',strike=340,fcoeff=0.4,dt=0.01,init_time=5.574361834871828461e+10}
after_vs340_3092410 = ridgecrest54.new{model_n='vert_slow',strike=340,fcoeff=0.4,dt=0.01,init_time=5.574361834871828461e+10}
...
vf330_1515453 = ridgecrest54.new{model_n='vert_fast',strike=330,fcoeff=0.4,dt=0.01,init_time=2.712094562139096069e+10}
