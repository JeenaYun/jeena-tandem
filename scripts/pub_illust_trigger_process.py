#!/usr/bin/env python3
"""
(Publication) Generate illustrative figure explaining the triggering process
...
plt.tight_layout()
if save_on: plt.savefig('/export/dump/jyun/perturb_stress/plots/illust_trigger_process.png',dpi=350)