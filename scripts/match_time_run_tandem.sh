...
# Safety check
existckp_full $model_n reference/outputs/checkpoint/step1515000

mpiexec -bind-to core -n 40 tandem $setup_dir/parameters_match_time.toml --petsc -ts_checkpoint_load ../reference/outputs/checkpoint/step1515000 -ts_checkpoint_freq_step 1 -ts_checkpoint_freq_physical_time 1000000000 -ts_checkpoint_freq_cputime 60 -options_file $tdhome/options/lu_mumps.cfg -options_file $tdhome/options/rk45.cfg -ts_monitor > $setup_dir/messages_$branch_n.log 
