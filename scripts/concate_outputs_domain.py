#!/usr/bin/env python3
'''
Concatenate truncated outputs due to the checkpointing feature (domain output)
By Jeena Yun
...
if write_on: 
    os.system('rm -f finished_concate_domain.dat')
    flog = open('messages/domainp_concat.log','w')
...
os.system('touch finished_concate_domain.dat')