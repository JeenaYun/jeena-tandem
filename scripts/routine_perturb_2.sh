...
branch_n=continue_after_pert8_vsdyn_340
...
# Safety check
existckp_full $model_n first_after_pert8_vsdyn_340/outputs/checkpoint/step1558000

# If safe, proceed
mpiexec -bind-to core -n 40 $tandem_aging $setup_dir/parameters_perturb_scenario_2.toml --final_time 2.712101834139096e+10 --petsc -ts_checkpoint_load ../first_after_pert8_vsdyn_340/outputs/checkpoint/step1558000 -ts_adapt_type basic -ts_checkpoint_path checkpoint -ts_checkpoint_freq_step 100 -ts_checkpoint_freq_physical_time 10000000000 -ts_checkpoint_freq_cputime 60 -options_file $tdhome/options/ridgecrest.cfg > $setup_dir/messages_$branch_n.log
