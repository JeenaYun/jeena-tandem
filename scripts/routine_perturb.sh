...
# Safety check
existckp_full $model_n after_pert8_vsX10_340/outputs/checkpoint/step1566950

# If safe, proceed
mpiexec -bind-to core -n 40 tandem $setup_dir/parameters_perturb_scenario.toml --petsc -ts_checkpoint_load ../after_pert8_vsX10_340/outputs/checkpoint/step1566950 -ts_adapt_type basic -ts_max_steps 1616954 -ts_checkpoint_freq_step 50 -ts_checkpoint_freq_physical_time 1000000000 -ts_checkpoint_freq_cputime 60 -options_file $tdhome/options/lu_mumps.cfg -options_file $tdhome/options/rk45.cfg -ts_monitor > $setup_dir/messages_$branch_n.log
